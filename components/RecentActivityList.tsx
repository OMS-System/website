...
import { STATUSES, CATEGORIES, formatDate } from '@/lib/constants';
      ...
      <div className="divide-y divide-[var(--border)] overflow-y-auto max-h-[380px]">
        {observations.length > 0 ? (
          observations.map((obs) => {
            const statusMeta = STATUSES[obs.status] || STATUSES.Open;
            const catMeta = CATEGORIES[obs.category] || CATEGORIES.SAF;
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col min-w-0 flex-1">
                  ...
                  <span className="text-xs text-[var(--dim)] truncate mt-0.5">
                    {obs.site}
                  </span>
                </div>
